package com.example.sohozshopping;
...
public class OrderItem_Activity extends AppCompatActivity
    ...
    Button confirm;
    private static final String URL = "http://mohammadsaifulcsepstu.info/sohozshopping/confirm_shopping.php";
    String my_url = "http://mohammadsaifulcsepstu.info/sohozshopping/unconfirm_shopping.php";
...
//        });
    ...
    void fetchinng_data(){
        ...
        com.example.sohozshopping.AppController.getInstance().addToRequestQueue(jsonArrayRequest);
